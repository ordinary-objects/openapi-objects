...
namespace Ordinary.Core.PenpotApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "http://localhost:3449/api/rpc";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "http://localhost:3449/api/rpc"},
        ...
        public Configuration(
            ...
            string basePath = "http://localhost:3449/api/rpc") : this()
        {
        ...
        {
            string report = "C# SDK (Ordinary.Core.PenpotApi) Debug Report:\n";
